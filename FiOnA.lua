...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,782717203,1874628385}   
...
function DevFiOnA(msg) 
local hash = database:sismember(bot_id.."Dev:FiOnA:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:FiOnA:2", user_id) then
var = true  
...
local UserName = (data.username_ or "fiona_team")
...
FiOnA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FiOnA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FiOnA_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 F𝙸𝙾𝙽𝙰.")  
...
function plugin_FiOnA(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.FiOnA and msg then
pre_msg = plugin.FiOnA(msg)
end
end
end
...
if DevFiOnA(msg) then
local bl = ' 𖤍︙اهلا عزيزي آلمـطـور\n 𖤍︙آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 𖤍︙تسـتطـيع‌‏ آلتحگم باوامر البوت\n 𖤍︙من خلاال الكيبورد خاص بك\n 𖤍︙قناة سورس البوت [اضغط هنا](t.me/fiona_team)'
local keyboard = {
{'𖤍 الاحصائيات 𖤍'},
{'𖤍 تعطيل التواصل 𖤍','𖤍 تفعيل التواصل 𖤍'},
{'𖤍 ضع اسم للبوت 𖤍','قائمه العام 𖤍','𖤍 ضع اسم للبوت 𖤍'},
{'۝ حصريات و تحديثات فيـونا ۝'},
{'المطورين 𖤍','الثانويين 𖤍'},
{'المشتركين 𖤍','الكروبات 𖤍'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك 𖤍','تغير الاشتراك'},
{'ضع كليشه ستارت 𖤍','حذف كليشه ستارت 𖤍'},
{'اذاعه 𖤍','اذاعه خاص 𖤍','اذاعه بالتثبيت 𖤍'},
{'اذاعه بالتوجيه 𖤍','اذاعه بالتوجيه خاص 𖤍'},
{'تفعيل الاشتراك الاجباري 𖤍','تعطيل الاشتراك الاجباري 𖤍'},
{'الاشتراك الاجباري 𖤍','وضع قناة الاشتراك 𖤍'},
{'تفعيل البوت الخدمي 𖤍','تعطيل البوت الخدمي 𖤍'},
{'تنظيف الكروبات 𖤍','تنظيف المشتركين 𖤍'},
{'جلب نسخه الاحتياطيه 𖤍'},
{'تحديث السورس 𖤍','الاصدار 𖤍'},
{'تحديث 𖤍','تحديث المتجر 𖤍'},
{'معلومات السيرفر 𖤍'},
{'الغاء 𖤍'},
}
...
if not DevFiOnA(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevFiOnA(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == '𖤍 تفعيل التواصل 𖤍' and DevFiOnA(msg) then  
...
if text == '𖤍 تعطيل التواصل 𖤍' and DevFiOnA(msg) then  
...
if text == 'تفعيل البوت الخدمي 𖤍' and DevFiOnA(msg) then  
...
if text == 'تعطيل البوت الخدمي 𖤍' and DevFiOnA(msg) then  
...
if text == 'ضع كليشه ستارت 𖤍' and DevFiOnA(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖤍︙ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت 𖤍' and DevFiOnA(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖤍︙تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر 𖤍' and DevFiOnA(msg) then 
...
if text == 'تحديث السورس 𖤍' and DevFiOnA(msg) then 
os.execute('rm -rf FiOnA.lua')
os.execute('wget https://raw.githubusercontent.com/FiOnA-TeaM/FiOnA/main/FiOnA.lua')
send(msg.chat_id_, msg.id_,' 𖤍︙تم تحديث السورس \n 𖤍︙لديك اخر اصدار لسورس فيونا\n 𖤍︙الاصدار » { v 1.8 }')
dofile('FiOnA.lua')  
end
if text == "تحديث 𖤍" then
dofile("FiOnA.lua")  
send(msg.chat_id_, msg.id_, "𖤍︙تم تحديث الملفات")
end

if text == 'تحديث المتجر 𖤍' and DevFiOnA(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/commands.lua")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'𖤍︙اهلا بك عزيزي\n𖤍︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n𖤍︙تابعنا لتصلك اخر التحديثات\n𖤍︙[قناة السورس](t.me/FiOnA_TeaM)')
dofile('FiOnA.lua')  
end
if text == 'الاصدار 𖤍' and DevFiOnA(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤍︙اصدار سورس فيونا \n 𖤍︙الاصدار »{ v 1.8 }')
end
if text == "𖤍 ضع اسم للبوت 𖤍" and DevFiOnA(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖤍︙ارسل اليه الاسم الان ")
return false
end
if text == '𖤍 الاحصائيات 𖤍' and DevFiOnA(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' 𖤍 الاحصائيات 𖤍 \n'..' 𖤍︙عدد الكروبات » {'..Groups..'}'..'\n 𖤍︙عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين 𖤍' and DevFiOnA(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖤍︙المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات 𖤍' and DevFiOnA(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖤍︙الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 𖤍") and DevFiOnA(msg) then
...
if text == ("الثانويين 𖤍") and DevFiOnA(msg) then
local list = database:smembers(bot_id..'Dev:FiOnA:2')
t = "\n 𖤍︙قائمة الثانويين \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "۝ حصريات و تحديثات فيـونا ۝" and DevFiOnA(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس فيونا*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇F𝙸𝙾𝙽𝙰 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/fiona_team"}},
}
...
-----------
if text == ("قائمه العام 𖤍") and DevFiOnA(msg) then
...
if text=="اذاعه خاص 𖤍" and msg.reply_to_message_id_ == 0 and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍︙ارسل الان اذاعتك؟ \n 𖤍︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه 𖤍" and msg.reply_to_message_id_ == 0 and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍︙ارسل الان اذاعتك؟ \n 𖤍︙للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 𖤍" and msg.reply_to_message_id_ == 0 and DevFiOnA(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍︙ارسل الان اذاعتك؟ \n 𖤍︙للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 𖤍" and msg.reply_to_message_id_ == 0  and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍︙ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص 𖤍" and msg.reply_to_message_id_ == 0  and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 𖤍' and DevFiOnA(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين 𖤍" and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات 𖤍" and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'𖤍︙عدد الكروبات الان » { '..#group..' }'..FiOnAk..''..FiOnA..'\n𖤍︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevFiOnA(msg) then
...
usertext = '\n 𖤍︙العضو » ['..result.title_..'](t.me/'..(username or 'fiona_team')..')'
status  = '\n 𖤍︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevFiOnA(msg) then
...
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevFiOnA(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevFiOnA(msg) then
...
if FiOnA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤍︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'fiona_team')..') \n 𖤍︙'..FiOnA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," 𖤍︙العضو : {["..data.first_name_.."](t.me/fiona_team)}\n 𖤍︙["..FiOnA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤍︙عذرا » {["..data.first_name_.."](t.me/fiona_team)}\n 𖤍︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevFiOnA(msg) then
send(msg.chat_id_, msg.id_,' 𖤍︙عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤍︙بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n 𖤍︙بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤍︙تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n 𖤍︙بواسطة {'..Name..'}'..
'\n 𖤍︙ايدي الكروب {'..IdChat..'}'..
'\n 𖤍︙اسم الكروب {['..NameChat..']}'..
'\n 𖤍︙عدد اعضاء الكروب *{'..NumMember..'}*'..
'\n 𖤍︙الرابط {['..LinkGp..']}'
if not DevFiOnA(msg) then
sendText(SUDO,Text,0,'md')
end
end
end,nil) 
...
send(msg.chat_id_, msg.id_,' 𖤍︙بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\n 𖤍︙بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤍︙تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤍︙تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n 𖤍︙بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤍︙تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevFiOnA(msg) then
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
if text == 'تحديث المتجر' and DevFiOnA(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/commands.lua")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/all.lua") 
...
if text and text:match("^تغير الاشتراك$") and DevFiOnA(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤍︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevFiOnA(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤍︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك 𖤍" and DevFiOnA(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖤍︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖤍$") and DevFiOnA(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤍︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري 𖤍" and DevFiOnA(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري 𖤍" and DevFiOnA(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖤍︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 𖤍" and DevFiOnA(msg) then  
...
send(msg.chat_id_, msg.id_, "𖤍︙عزيزي >>["..mrFiOnA2.username_.."](https://t.me/"..(mrFiOnA2.username_ or "fiona_team")..")\n𖤍︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."FiOnA:teh"..msg.chat_id_).."} بجانب اسمك\n𖤍︙عدد المحاولات المتبقيه {"..(tonumber(mrFiOnA_nnn) - tonumber(mrFiOnA_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '𖤍︙تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖤍︙تم تعطيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖤍︙تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '𖤍︙تم تعطيل تنبيه المعرف')
...
𖤍 ⦑ SOURCE FiOnA ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𖤍︙[Source Channel](t.me/fiona_team)   
𖤍︙[Devloper one](t.me/BBB43)     
𖤍︙[Devloper two](t.me/abbasfadhil) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text == 'رفع نسخه الاحتياطيه' and DevFiOnA(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جلب نسخه الاحتياطيه' and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,"𖤍︙تم ترتيب الاوامر بالشكل التالي ~\n- ايدي - ا .\n- رفع مميز - م .\n-رفع ادمن - اد .\n- رفع مدير - مد . \n- رفع منشى - من . \n- رفع منشئ الاساسي - اس  .\n- رفع مطور - مط .\n-رفع مطور ثانوي - ثانوي .\n- تنزيل الكل - تك .\n- تعطيل الايدي بالصوره - تعط .\n- تفعيل الايدي بالصوره - تفع .\n- الرابط - ر .\n- ردود المدير - رر .\n- مسح المكتومين - ،، .\n- اضف رد - رد .\n- مسح سحكاتي - سح .\n- مسح رسائلي - رس .")  
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖤍︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'fiona_team')..') \n 𖤍︙تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 𖤍︙تم تفعيل امر كول'
database:del(bot_id..'Speak:after:me'..msg.chat_id_)  
else
Text = ' 𖤍︙بالتاكيد تم تفعيل امر كول'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤍︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'fiona_team')..') \n 𖤍︙تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevFiOnA(msg) then    
dofile('FiOnA.lua')  
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevFiOnA(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n 𖤍︙تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevFiOnA(msg) then
local list = database:smembers(bot_id..'GBan:User')
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevFiOnA(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevFiOnA(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevFiOnA(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevFiOnA(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevFiOnA(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevFiOnA(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevFiOnA(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if text and text:match("^الغاء العام @(.*)$") and DevFiOnA(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevFiOnA(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevFiOnA(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n 𖤍︙تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevFiOnA(msg) then
local list = database:smembers(bot_id..'Sudo:User')
...
if text == 'الملفات' and DevFiOnA(msg) then
t = ' 𖤍︙ملفات السورس فيونا ↓\n ٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevFiOnA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖤍︙اهلا بك في متجر ملفات فيونا\n 𖤍︙ملفات السورس ↓\nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n 𖤍︙علامة تعني { ✔️ } ملف مفعل\n 𖤍︙علامة تعني { ✖ } ملف معطل\n 𖤍︙قناة سورس فيونا ↓\n".." 𖤍︙[اضغط هنا لدخول](t.me/fiona_team) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevFiOnA(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/FiOnA-TeaM/Files_FiOnA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('FiOnA.lua')  
else
send(msg.chat_id_, msg.id_," 𖤍︙عذرا الملف لايدعم سورس فيونا \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevFiOnA(msg) then
...
if text == "مسح الملفات" and DevFiOnA(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," 𖤍︙تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevFiOnA(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevFiOnA(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:FiOnA'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:FiOnA'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:FiOnA'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:FiOnA'..msg.chat_id_,true)  
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:FiOnA'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-FiOnA")
send(msg.chat_id_, msg.id_," 𖤍︙منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
function Function_FiOnA(extra, result, success)
database:sadd(bot_id.."Dev:FiOnA:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","𖤍︙تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_FiOnA, nil)
return false 
end
...
function Function_FiOnA(extra, result, success)
database:srem(bot_id.."Dev:FiOnA:2", result.sender_user_id_)
...
function Function_FiOnA(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:FiOnA:2", result.id_)
...
database:srem(bot_id.."Dev:FiOnA:2", userid)
...
database:del(bot_id.."Dev:FiOnA:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤍︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤍︙العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖤍︙قائمة مطايه الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖤍︙تم رفع العضو مطي في الكروب \n 𖤍︙تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيل العضو مطي في الكروب\n 𖤍︙تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم مسح جميع الحاتات')
end
if text == ("تاك للحاتات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖤍︙قائمه حاتات الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖤍︙تم رفع العضــو الحاته في الكروب \n 𖤍︙تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيل العضــو الحاته من الكروب\n 𖤍︙مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم مسح جميع الصاكين')
end
if text == ("تاك للصاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n 𖤍︙قائمه صاكين الكروب \nٴٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤍︙تم رفع العضــو الصاك في الكروب \n 𖤍︙تعال حبي الصاك نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيل العضــو الصاك من الكروب\n 𖤍︙مشيي مو خوش صاك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖤍︙قائمة صخوله الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local  statuss  = '\n 𖤍︙تم رفع المتهم صخل بالكروب\n 𖤍︙الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖤍︙قائمة الجلاب الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local  statuss  = '\n 𖤍︙تم رفع جلب في الكروب\n 𖤍︙تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تنزيل جميع القروده بالكروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖤍︙قائمة القروده الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local  statuss  = '\n 𖤍︙تم رفع ضلع في الكروب\n 𖤍︙تعال حبيبي انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيل ضلع من الكروب\n 𖤍︙بعد لتراويني وجهك ياحقير وجيب فلوس الشرب'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local  statuss  = '\n 𖤍︙تم رفع ضلعه في الكروب\n 𖤍︙تعاي صرتي من ضلعاتي تمكيجي وخل نروح للمول نرقم صاكين'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيل ضلعه من الكروب\n 𖤍︙دمشي ولي ملطخه وجهه تلطخ وتريد ترقم صاكين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖤍︙قائمة البقرات الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 𖤍︙قائمة الطليان الكروب \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local  statuss  = '\n 𖤍︙تم رفع الطلي في الكروب\n 𖤍︙طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n 𖤍︙تم تنزيل زاحف من الكروب\n 𖤍︙هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local  statuss  = '\n 𖤍︙تم رفع جريذي في الكروب\n 𖤍︙خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤍︙لا امتلك صلاحية اضافة مشرفين يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BO6OK')..')'
status  = '\n 𖤍︙الايدي » `'..result.sender_user_id_..'`\n 𖤍︙تم رفعه ادمن بالكروب '
send(msg.chat_id_, msg.id_, usertext..status)
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖤍︙عذرا عزيزي المستخدم هذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end      
usertext = '\n 𖤍︙العضو » ['..result.title_..'](t.me/'..(username or 'BO6OK')..')'
status  = '\n 𖤍︙تم رفعه ادمن بالكروب '
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, ' 𖤍︙لا يوجد حساب بهذا المعرف')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤍︙لا امتلك صلاحية ازالة مشرفين يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BO6OK')..')'
status  = '\n 𖤍︙الايدي » `'..result.sender_user_id_..'`\n 𖤍︙تم تنزيله ادمن من الكروب'
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n ​𖤍︙الايدي » '..result.sender_user_id_..'\n 𖤍︙تم رفعه منشئ بالكروب'
send(msg.chat_id_, msg.id_, usertext..status)
...
usertext = '\n 𖤍︙العضو » ['..result.title_..'](t.me/'..(username or 'WviivW')..')'
status  = '\n 𖤍︙تم رفعه منشئ بالكروب'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n 𖤍︙الايدي » '..result.sender_user_id_..'\n 𖤍︙تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
' }\n'..' 𖤍︙ردود المدير » { '..rdmder..
' }\n'..' 𖤍︙ردود المطور » { '..rdsudo..
' }\n'..' 𖤍︙الايدي » { '..idgp..
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤍︙تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤍︙تم ازالة ترحيب الكروب') 
end
end
...
if text == 'مسح كليشه المطور' and DevFiOnA(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 𖤍︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevFiOnA(msg) then
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖤍︙لا توجد بوتات في الكروب")
else
...
send(msg.chat_id_, msg.id_," 𖤍︙تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖤍︙تم ازالة قوانين الكروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤍︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'fiona_team')..')'..'\n 𖤍︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevFiOnA(msg) then  
...
if text == 'تعطيل الاذاعه' and DevFiOnA(msg) then  
...
if text == 'تفعيل التواصل' and DevFiOnA(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n 𖤍︙تم تفعيل التواصل' 
else
...
if text == 'تعطيل التواصل' and DevFiOnA(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n 𖤍︙تم تعطيل التواصل' 
else
...
if text == 'تفعيل البوت الخدمي' and DevFiOnA(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevFiOnA(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖤍︙تستطيع تنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖤍︙تم تنظيف {'..num..'}')  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖤍︙تستطيع مسح 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if database:get(bot_id..'Bc:Bots') and not DevFiOnA(msg) then 
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤍︙ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖤍︙تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:FiOnA:2',msg.sender_user_id_) then
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevFiOnA(msg) then 
...
send(msg.chat_id_, msg.id_,"𖤍︙تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevFiOnA(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n𖤍︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"𖤍︙تم حفظ الرد بنجاح")
return false  
end  
end

if text == "اضف رد للكل" and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,"𖤍︙ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,"𖤍︙ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '𖤍︙الان ارسل الرد الذي تريد اضافته \n𖤍︙قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n𖤍︙يمكنك اضافه الى النص :\n𖤍︙🌐 `#username` > معرف المستخدم\n𖤍︙📨 `#msgs` > عدد رسائل المستخدم\n𖤍︙📎 `#name` > اسم المستخدم\n𖤍︙🆔 `#id` > ايدي المستخدم\n𖤍︙🎖 `#stast` > رتبه المستخدم \n𖤍︙📝 `#edit` > عدد السحكات ')
...
send(msg.chat_id_, msg.id_,"𖤍︙تم ازالة الرد من قائمه ردود المطور")
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n 𖤍︙ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:FiOnA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:FiOnA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:FiOnA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"𖤍︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:FiOnA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:FiOnA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:FiOnA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:FiOnA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:FiOnA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:FiOnA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:FiOnA:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"𖤍︙تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"𖤍︙تم مسح ردود المدير")
end
if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = "𖤍︙قائمه ردود المدير \nٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴ\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"𖤍︙تم ازالة الرد من قائمه الردود")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
local Text ='𖤍︙تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 F𝙸𝙾𝙽𝙰.',url="t.me/fiona_team"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,'𖤍︙لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖤍︙قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖤍︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..') '
status  = '\n𖤍︙الايدي » '..result.sender_user_id_..'\n𖤍︙تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,'𖤍︙وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖤍︙لقبك هو : '..GeId.result.custom_title) 
end
end
...
database:set(bot_id.."fiona_team:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."fiona_team:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."fiona_team:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."fiona_team:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"𖤍︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."fiona_team:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "𖤍︙تم تعطيل تاك المشرفين")
end

if text == 'صيح المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
if database:get(bot_id.."fiona_team:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فيونا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"𖤍︙ارسل الرد الذي اريد اضافته")
end
...
database:set(bot_id.."botss:FiOnA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"𖤍︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:FiOnA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text"..test, text)  
end  
send(msg.chat_id_, msg.id_,"𖤍︙تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
local test = database:get(bot_id.."botss:FiOnA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text1"..test, text)  
end  
send(msg.chat_id_, msg.id_,"𖤍︙تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
local test = database:get(bot_id.."botss:FiOnA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:FiOnA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:FiOnA:Add:Rd:Sudo:Text2"..text)   
...
send(msg.chat_id_, msg.id_,'𖤍︙تم مغادرة المجموعه') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
if text == 'تفعيل المغادره' and DevFiOnA(msg) then   
...
if text == 'تعطيل المغادره' and DevFiOnA(msg) then  
...
Text = '\n 𖤍︙تم تعطيل ردود المدير' 
else
Text = '\n 𖤍︙بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍︙تم تفعيل ردود المطور' 
else
Text = '\n 𖤍︙بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍︙تم تعطيل ردود المطور' 
else
Text = '\n 𖤍︙بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
local iduser = result.sender_user_id_
...
local FiOnA = ' 𖤍︙عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖤍︙عدد المطرودين : '..data.kicked_count_..
'\n\n 𖤍︙عدد الاعضاء : '..data.member_count_..
'\n\n 𖤍︙عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖤍︙اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, FiOnA) 
end,nil)
end,nil)
end 
...
send(msg.chat_id_, msg.id_,' 𖤍︙عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖤍︙تم طردك من الكروب') 
...
send(msg.chat_id_, msg.id_,' 𖤍︙انت منشئ الكروب') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤍︙انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤍︙تم تنزيل الكل من الرتب الاتيه \n 𖤍︙المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,FiOnA,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (FiOnA.total_count_ or 0)
local interaction = Total_Msg(Msguser)
local rtpg = rtpa
local FiOnAa = {
" 𖤍︙اروح فدوه للحلوين",
" 𖤍︙حلوة حبيبي معليك بالمضغوطين",
" 𖤍︙جهرتك منورة ",
" 𖤍︙هاي شكد حلو انتة",
" 𖤍︙كيكه وربي",
" 𖤍︙اصلا مطوري احلئ",
...
local rdphoto = FiOnAa[math.random(#FiOnAa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, FiOnA.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, FiOnA.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 𖤍︙ايديك ➸ '..msg.sender_user_id_..'\n 𖤍︙معرفك ➸ '..username..'\n 𖤍︙رتبتك ➸ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤍︙موقعك ➸ '..rtpa..'\n 𖤍︙تفاعلك ➸ '..Total_Msg(Msguser)..'\n 𖤍︙رسائلك ➸ '..Msguser..'\n 𖤍︙نسبه تفاعلك ➸ '..string.sub(nspatfa, 1,5)..' %\n 𖤍︙السحكات ➸ '..edit..'\n 𖤍︙نقاطك ➸ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 𖤍︙ايديك ➸ '..msg.sender_user_id_..'\n 𖤍︙معرفك ➸ '..username..'\n 𖤍︙رتبتك ➸ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤍︙موقعك ➸ '..rtpa..'\n 𖤍︙تفاعلك ➸ '..Total_Msg(Msguser)..'\n 𖤍︙رسائلك ➸ '..Msguser..'\n 𖤍︙نسبه  تفاعلك ➸ '..string.sub(nspatfa, 1,5)..' %\n 𖤍︙السحكات ➸ '..edit..'\n 𖤍︙نقاطك ➸ '..NUMPGAME..']\n')
else
...
if text == "تنظيف المشتركين" and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات" and DevFiOnA(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
FiOnA = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,FiOnA)  
...
FiOnA = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,FiOnA)  
...
if text == 'استعاده الاوامر' and DevFiOnA(msg) then
...
send(msg.chat_id_, msg.id_, '𖤍︙تم تعطيل الزغرفه')
database:set(bot_id.." FiOnA:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'𖤍︙تم تفعيل الزغرفه')
database:set(bot_id.." FiOnA:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." FiOnA:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ F𝙸𝙾𝙽𝙰 ━━━━≫ٴٴ\n𖤍︙➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 F𝙸𝙾𝙽𝙰. ](t.me/fiona_team)➤ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '𖤍︙تم تعطيل الابراج')
database:set(bot_id.." FiOnA:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'𖤍︙تم تفعيل الابراج')
database:set(bot_id.." FiOnA:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." FiOnA:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." FiOnA:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '𖤍︙تم تعطيل حساب العمر')
database:set(bot_id.." FiOnA:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." FiOnA:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." FiOnA:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."FiOnA:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'𖤍︙تم تفعيل الافلام')
database:set(bot_id.."FiOnA:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."FiOnA:movie_bot"..msg.chat_id_) == "open" then
...
𖤍︙تنظيف + العدد
𖤍︙تنظيف الميديا ← لمسح جميع الميديا
𖤍︙امسح ← لمسح عدد من الوسائط الموجوده
𖤍︙تنزيل الكل
𖤍︙تنزيل جميع الرتب
𖤍︙منع + برد
𖤍︙~ الصور + متحركه + ملصق ~
...
send(msg.chat_id_, msg.id_, ' 𖤍︙تم تعطيل اوامر التحشيش')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, '  𖤍︙تم تفعيل اوامر التحشيش')
...
if FiOnA1_Msg then    
send(msg.chat_id_, msg.id_," 𖤍︙"..FiOnA1_Msg)
...
end -- end new msg dev.mr FiOnA 
end -- end callback dev.mr FiOnA
