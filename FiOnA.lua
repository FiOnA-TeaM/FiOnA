...
{'⌔ ضع اسم للبوت ⌔','قائمه العام ⌔','⌔ ضع اسم للبوت ⌔'},
...
local FiOnA = '⌔︙عدد الادمنيه : '..data.administrator_count_..
...
{{text = '- ғɪᴏɴᴀ ᴛᴇᴀᴍ', url="t.me/fiona_team"}},
}
local msg_id = msg.id_/2097152/0.5
