...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-fiona/Files_fiona/main/File_Bot/commands.lua") 
...
local hash = database:sismember(bot_id.."BBB43:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevFiOnA(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif database:sismember(bot_id..'BBB43:MN:TF'..chat_id, user_id) then
var = true 
...
fionaMsg = 'قمة التفاعل'
elseif msgs < 5500 then 
fionaMsg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
fionaMsg = 'ملك التفاعل' 
elseif msgs < 9500 then 
fionaMsg = 'امبروطور التفاعل' 
...
if text == 'ضع كليشه ستارت ℘' and DevFiOnA(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ℘︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ℘' and DevFiOnA(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ℘' and DevFiOnA(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/SRC-fiona/fiona/main/fiona.lua')
...
if text == 'الاحصائيات ℘' and DevFiOnA(msg) then 
...
if text == 'المشتركين ℘' and DevFiOnA(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ℘' and DevFiOnA(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("الثانويين ℘") and DevFiOnA(msg) then
...
-------------
if text == "🐉 حصريات و تحديثات دراكـون 🐉" and DevFiOnA(msg) then  
local updatech =[[
...
{{text = '📂┇F𝙸𝙾𝙽𝙰 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/FIfa"}},
}
...
if text == ("قائمه الكتم العام ℘") and DevFiOnA(msg) then
...
if text=="اذاعه خاص ℘" and msg.reply_to_message_id_ == 0 and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ℘" and msg.reply_to_message_id_ == 0 and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ℘" and msg.reply_to_message_id_ == 0 and DevFiOnA(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ℘" and msg.reply_to_message_id_ == 0  and DevFiOnA(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ℘" and msg.reply_to_message_id_ == 0  and DevFiOnA(msg) then 
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..fionak..''..fiona..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'fiona_team')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if fiona1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'fiona_team')..') \n ℘︙ '..fiona1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/fiona_team)}\n ℘︙ ["..fiona_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/fiona_team)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == "حذف رساله الاشتراك ℘" and DevFiOnA(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ℘︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ℘$") and DevFiOnA(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ℘" and DevFiOnA(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ℘" and DevFiOnA(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ℘︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ℘" and DevFiOnA(msg) then  
...
database:set(bot_id.."AL:AddBBB43:stats","✔")
end
...
local MRSoOoFi = database:get(bot_id.."AL:AddBBB43:stats") or "لم يتم التحديد"
...
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
send(msg.chat_id_, msg.id_, '℘︙ تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
...
function BBB43_name(t1,t2)
if t2.id_ then 
name_MRFiinAA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRFiinAA then 
names_MRFiinAA = database:smembers(bot_id.."fiona:blocname"..msg.chat_id_) or ""
if names_MRFiinAA and names_MFiFnAnA[1] then 
for i=1,#names_MRFiinAA do 
if name_MRFiinAA:match("(.*)("..names_MFiFnAnA[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, BBB43_name)
end
...
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
send(msg.chat_id_, msg.id_, '℘︙ تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
...
function FnOnAA_mFOOnAnA_new(FiOnAOnA1FFOnAiOnA2)
if mrFnOnAA2 and mFOOnAnA2.first_name_ then 
if mrFnOnAA2.first_name_:match("(.*)"..database:get(bot_id.."fiona:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."fiona:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrFnOnAA_nnn = database:get(bot_id.."fiona:nump"..msg.chat_id_) or 5
local mrFnOnAA_nnn2 = database:get(bot_id.."fiona:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrFnOnAA_nnn2) == tonumber(mFOOnAnA_nnn) or tonumber(FiOnAOnA_nnn2) > tonumberFFOnAiOnA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."fiona:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrFnOnAA2.username_.."](https://t.me/"..(mFOOnAnA2.username_ or "fiona_team")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."fiona:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(FiOnAOnA_nnn) - tonumberFFOnAiOnA_nnn2)).."}")
end
end
end
end
bnnaGet(id, FnOnAA_mFOOnAnA_new)
end
end
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
send(msg.chat_id_, msg.id_, '℘︙ تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:fa:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
send(msg.chat_id_, msg.id_, '℘︙ تم تعطيل تنبيه الاسماء')
database:set(bot_id.."Ttn:fa:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:fa:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
...
if text == "تفعيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
send(msg.chat_id_, msg.id_, '℘︙ تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
...
if text == "تفعيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
send(msg.chat_id_, msg.id_, '℘︙ تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddBBB43:stats") == "✔" then
...
℘︙ [Source Update ](t.me/FIfa)     
℘︙ [Source developer](t.me/BBB43)     
℘︙ [fiona programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS fiona](t.me/fiona_teambot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'fiona_team')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'fiona_team')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevFiOnA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-fiona/Files_fiona/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات دراكون\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉  ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉  ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس دراكون ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/fiona_team) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-fiona/Files_fiona/main/File_Bot/"..file)
if res == 200 then
...
if database:get(bot_id..'DRAGOON:change:FnOnAA'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:FnOnAA'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:FnOnAA'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:FnOnAA'..msg.chat_id_,true)  
Text = '\n ℘︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:FnOnAA'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
database:del(bot_id..'BBB43:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'BBB43:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'BBB43:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'BBB43:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'fiona_team')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'BBB43:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'BBB43:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'BBB43:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'fiona_team')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'BBB43:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fiona_team')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'fiona_team')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'BBB43:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'BBB43:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."BBB43:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."BBB43:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."BBB43:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."BBB43:allM"..msg.chat_id_)
...
if database:sismember(bot_id..'BBB43:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'BBB43:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
local FnOnAA = ' ℘︙ عدد الادمنيه : '..data.administrator_count_..
'\n\n ℘︙ عدد المطرودين : '..data.kicked_count_..
'\n\n ℘︙ عدد الاعضاء : '..data.member_count_..
'\n\n ℘︙ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n ℘︙  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, FnOnAA) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,FnOnAA,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (FnOnAA.total_count_ or 0)
...
local rdphoto = FnOnAAa[math.random(FOOnAnAa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, FnOnAA.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
FnOnAA = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,FnOnAA)  
...
FnOnAA = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,FnOnAA)  
...
{
{text = 'F𝙸𝙾𝙽𝙰 T𝙴𝙰𝙼', url="t.me/fiona_team"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/FnOnAA"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." FnOnAA:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الزغرفه')
database:set(bot_id.." FnOnAA:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." FnOnAA:zhrf_Bots"..msg.chat_id_) == "open" then
local TextZhrfa = text:match("^زغرفه (.*)$")
zh = https.request('https://rudi-dev.tk/Amir1/fiona.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n℘︙ قائمه الزغرفه \nٴ≪┉ ┉ ┉ ┉ ┉  ┉  ┉ ┉ ┉ ┉≫ٴ\n"
i = 0
...
database:set(bot_id.." FnOnAA:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الابراج')
database:set(bot_id.." FnOnAA:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." FnOnAA:brj_Bots"..msg.chat_id_) == "open" then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://rudi-dev.tk/Amir2/fiona.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
database:set(bot_id.." FnOnAA:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '℘︙ تم تعطيل حساب العمر')
database:set(bot_id.." FnOnAA:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." FnOnAA:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." FnOnAA:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://rudi-dev.tk/Amir3/fiona.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
database:set(bot_id.."FiinAA:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الافلام')
database:set(bot_id.."FiinAA:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."FiinAA:movie_bot"..msg.chat_id_) == "open" then
...
end -- end new msg dev.mr FnOnAA 
end -- end callback dev.mr FnOnAA
